...
*/
        ...
        $column_names = array(
            'TAG'   => get_string( 'gradebook:tag_desc', 'block_leapgradetracking' ),
            'L3VA'  => get_string( 'gradebook:l3va_desc', 'block_leapgradetracking' ),
            'MAG'   => get_string( 'gradebook:mag_desc', 'block_leapgradetracking' ),
        );
